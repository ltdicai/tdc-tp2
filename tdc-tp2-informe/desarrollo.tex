...
\begin{figure}[H]
  \centering
  \includegraphics[scale = 0.6]{imagenes/mapa.png}
...
\begin{itemize}
  \item EEUU:      sudo python traceroute.py www.cs.uoregon.edu -tr n -p 0.3 -m 30 -o EEUU_OREGON_n
  \item JAPON:     sudo python traceroute.py www.u-tokyo.ac.jp  -tr n -p 0.3 -m 30 -o JAP_n
  \item RUSIA:     sudo python traceroute.py msu.ru             -tr n -p 0.3 -m 30 -o RUSIA_n
  \item SUDAFRICA: sudo python traceroute.py www.unisa.ac.za    -tr n -p 0.3 -m 30 -o AFR_n 
\end{itemize}
