...
Si bien todos los tamaños de ráfagas devuelven caminos con igual cantidad de hops, a veces algunos host no llegan a responder. Por ejemplo, el host con IP 4.68.72.66 (hop 11 tanto del camino a EEUU como a Rusia) no parece detectarse a menos que la ráfaga sea grande. Suponemos que el umbral de timeout que utilizamos puede ser demasiado bajo, o que este . 
