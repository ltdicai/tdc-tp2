...
A continuación exponemos los resultados obtenidos para los cuatro experimentos. 

En las siguientes tablas mostramos los resultados obtenidos para distintos tamaños de ráfagas. 
Notar que solo estamos utilizando el RTT promedio, eliminando previamente los outliers.
